...
def initialize_stylegan():
    ...
    url = 'https://drive.google.com/uc?id=1zwhFLIvQYyNVOwQCLAhIJHmN7sjvAM84&confirm=t' # karras2019stylegan-ffhq-1024x1024.pkl
...
def initialize_feature_extractor():
    ...
    url = 'https://drive.google.com/uc?id=1fk6r8vetqpRShtEODXm9maDytbMkHLfa&confirm=t' # vgg16.pkl
